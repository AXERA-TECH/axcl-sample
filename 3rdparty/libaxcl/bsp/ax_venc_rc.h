...
#define VENC_MAX_BITRATE (160 * 1000)

#define VENC_BITRATE_RATIO    (1000)
#define VENC_MIN_INTRADELTAQP (-51)
#define VENC_MAX_INTRADELTAQP (51)

/* IDR interval */
#define VENC_MIN_IDR_INTERVAL (1)
#define VENC_MAX_IDR_INTERVAL (65536)

/* qp range */
#define VENC_MIN_FIXED_QP (-1)
...
#define VENC_MIN_I_PROP (1)
#define VENC_MAX_I_PROP (100)

/* cvbr params */
#define VENC_MIN_SHORT_TERM_STAT_TIME (1)   /* in seconds */
#define VENC_MAX_SHORT_TERM_STAT_TIME (120) /* in seconds */

#define VENC_MIN_LONG_TERM_STAT_TIME (1)    /* in seconds */
#define VENC_MAX_LONG_TERM_STAT_TIME (1440) /* in seconds */

#define VENC_MAX_LONG_TERM_BITRATE_LOW  (2)      /* in kbps */
#define VENC_MAX_LONG_TERM_BITRATE_HIGH (614400) /* in kbps */

#define VENC_MIN_LONG_TERM_BITRATE_LOW  (0)      /* in kbps */
#define VENC_MIN_LONG_TERM_BITRATE_HIGH (614400) /* in kbps */
/* Difference between FrameLevelMinQp and MinQp */
#define VENC_MIN_QP_DELTA_LOW  (0)
#define VENC_MIN_QP_DELTA_HIGH (4)
