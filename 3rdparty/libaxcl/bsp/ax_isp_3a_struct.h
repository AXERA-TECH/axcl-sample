...
#define AX_ISP_AWB_COLOR_DIFF_NUM           (16)
...
typedef struct {
    ...
    AX_U8  nColorDiffCnt;        /* Accuracy:U8    Range:[0, 15] */
    AX_U32 nColorDiffList[AX_ISP_AWB_COLOR_DIFF_NUM];   /* Accuracy:U4.10  Range:[0, 16383]*/
    AX_U32 nDampRatioList[AX_ISP_AWB_COLOR_DIFF_NUM];   /* Accuracy:U1.20 Range:[0, 1048576 (1024*1024)] */
...
typedef struct{
    ...
    AX_S32  nUpSlopeTh;            /* Accuracy: S8.10 Range: [-262144, 262144] */
    AX_S32  nDownSlopeTh;          /* Accuracy: S8.10 Range: [-262144, 262144] */
...
//  AF ALG Param
////////////////////////////////////////////////////////////////////////////////////
#define AX_CAF_DIRECTIONS    (6)
#define AX_CAF_NAME_NUM      (20)
...
typedef struct {
    ...
    AX_U32 nCoeffV;                               /* Accuracy:U6.10 Range:[10, 1024] */
...
// typedef struct {
//     AX_U8  nMode;                                // Accuracy:U2 Range:[0, 2]
//     AX_U32 nManualCode;                          // Accuracy:U10 Range:[0, 1023]
// } AX_ISP_CAF_START_SIGNAL_T;
