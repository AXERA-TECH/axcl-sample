...
AX_S32 AX_ISP_IQ_AwbSyncInit(AX_U8 pipe);
AX_S32 AX_ISP_IQ_AwbSyncDeInit(AX_U8 pipe);
AX_S32 AX_ISP_IQ_AwbSyncCalibration(AX_U8 pipe, AX_ISP_IQ_AWB_SYNC_RATIO_T *pAwbSyncRatio);
AX_S32 AX_ISP_IQ_SetAwbSyncParam(AX_U8 pipe, AX_ISP_IQ_AWB_SYNC_RATIO_T *pAwbSyncRatio);
AX_S32 AX_ISP_IQ_GetAwbSyncParam(AX_U8 pipe, AX_ISP_IQ_AWB_SYNC_RATIO_T *pAwbSyncRatio);
...
/* AE lock/release api for app to make AE lock/release. */
AX_S32 AX_ISP_ALG_AeLock(AX_U8 pipe);
AX_S32 AX_ISP_ALG_AeRelease(AX_U8 pipe);
...
AX_S32 AX_ISP_ALG_Ae_AFDInit(AX_U8 pipe, AX_AE_AFD_LOG_T *pAFDLog, AX_U32 nZoneRow, AX_AE_AFD_OUT_T *pAFDOut);
AX_S32 AX_ISP_ALG_Ae_AFDDeInit(AX_U8 pipe);
AX_S32 AX_ISP_ALG_Ae_AFDRun(AX_U8  pipe, AX_AE_AFD_LOG_T *pAFDLog, AX_ISP_AE_INPUT_INFO_T *pAeInputInfo, AX_F32 refVal, AX_F32 fLineTime,
                            AX_AE_AFD_PARAMS_T *pAFDParams, AX_AE_AFD_OUT_T *pAFDOut);


AX_S32 AX_ISP_ALG_AwbInit(AX_U8 pipe, AX_ISP_AWB_INITATTR_T *pAwbInitParam, AX_ISP_AWB_RESULT_T *pAeResult);
