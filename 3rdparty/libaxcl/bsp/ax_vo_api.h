...
#define AX_VO_DEV_MAX           (3)
#define AX_VO_LAYER_MAX         (32)
#define AX_VO_CHN_MAX           (72)
...
#define AX_ERR_VO_MEMCPY_FAIL                 AX_DEF_ERR(AX_ID_VO, AX_ID_VO_PUB_SMOD, 0x88)
...
typedef enum {
    ...
    AX_VO_OUT_FMT_RGB101010,
    AX_VO_OUT_FMT_YUV422,
    AX_VO_OUT_FMT_YUV422_10,
    AX_VO_OUT_FMT_BUTT
} AX_VO_OUT_FMT_E;
...
typedef enum {
    AX_HDMI_EVENT_HOTPLUG = 0x10,
    AX_HDMI_EVENT_NO_PLUG,
    AX_HDMI_EVENT_BUTT,
} AX_HDMI_EVENT_TYPE_E;
...
typedef enum {
    AX_VO_PCLK_ADJ_MODE_INT,
    AX_VO_PCLK_ADJ_MODE_FRA,
    AX_VO_PCLK_ADJ_MODE_MIX,
    AX_VO_PCLK_ADJ_MODE_BUTT
} AX_VO_PCLK_ADJ_MODE_E;

typedef enum {
    AX_VO_PCLK_ADJ_TYPE_FREF,
    AX_VO_PCLK_ADJ_TYPE_FVCO,
    AX_VO_PCLK_ADJ_TYPE_BUTT
} AX_VO_PCLK_ADJ_TYPE_E;

typedef struct axPCLK_ADJ_PARAM {
    AX_U32 u32Fref;
    AX_U32 u32Fvco;
    AX_U32 u32PreDiv;
    AX_U32 u32PostDiv;
...
typedef enum {
    AX_HDMI_VIDEO_MODE_UNUSED = 0,
    AX_HDMI_VIDEO_MODE_RGB444,
    AX_HDMI_VIDEO_MODE_YUV444,
    AX_HDMI_VIDEO_MODE_YUV422,
    AX_HDMI_VIDEO_MODE_YUV420,
    AX_HDMI_VIDEO_MODE_BUTT
} AX_HDMI_VIDEO_MODE_E;
...
#define AX_VO_VPLL_CFG_MASK         (0xFF)

#define AX_VO_FLAG_PCLK_ADJ              (1 << 0)
#define AX_VO_FLAG_VPLL_DIV_INT_REF_21M  (1 << 1)
#define AX_VO_FLAG_HDMI_PHY_INIT_SINGLE  (1 << 2)
...
typedef enum axVO_BG_FILL_E {
    AX_VO_BG_FILL_NORMAL = 0,
    AX_VO_BG_FILL_ONCE = 1,
    AX_VO_BG_FILL_BUTT
} AX_VO_BG_FILL_E;
...
typedef struct axVO_VIDEO_LAYER_ATTR_T {
    AX_VO_RECT_T stDispRect;              /* RW; Display resolution */
...
typedef struct axVO_DISPLAY_MODE_T {
    ...
    struct {
        AX_U32 u32Clock;
        AX_U16 u16HDisplay, u16HSyncStart, u16HSyncEnd, u16HTotal;
        AX_U16 u16VDisplay, u16VSyncStart, u16VSyncEnd, u16VTotal;
        AX_U16 u16Refresh;
        AX_U32 u32Type;
        AX_U32 u32Flags;
...
AX_S32 AX_VO_PCLK_AdjSet(VO_DEV VoDev, AX_VO_PCLK_ADJ_TYPE_E enAdjType, AX_VO_PCLK_ADJ_MODE_E enAdjMode, const AX_PCLK_ADJ_PARAM_T *pstPclkAdjParam);
AX_S32 AX_VO_PCLK_AdjGet(VO_DEV VoDev, AX_VO_PCLK_ADJ_TYPE_E enAdjType, AX_PCLK_ADJ_PARAM_T *pstPclkAdjParam);
...
AX_S32 AX_VO_HDMI_Force_GetEDID(AX_HDMI_ID_E enHdmi, AX_HDMI_EDID_T *pstEdidData);
...
AX_S32 AX_VO_SendFrame2Disp(VO_LAYER VoLayer, AX_VIDEO_FRAME_T *pstVoFrame, AX_S32 s32MS);
...
AX_S32 AX_VO_PauseChn(VO_LAYER VoLayer, VO_CHN VoChn);
AX_S32 AX_VO_ResumeChn(VO_LAYER VoLayer, VO_CHN VoChn);

AX_S32 AX_VO_RefreshChn(VO_LAYER VoLayer, VO_CHN VoChn);

AX_S32 AX_VO_StepChn(VO_LAYER VoLayer, VO_CHN VoChn);
...
AX_S32 AX_VO_SetChnFrameRate(VO_LAYER VoLayer, VO_CHN VoChn, AX_F32 f32ChnFrmRate);
AX_S32 AX_VO_GetChnFrameRate(VO_LAYER VoLayer, VO_CHN VoChn, AX_F32 *f32ChnFrmRate);

AX_S32 AX_VO_GetChnPTS(VO_LAYER VoLayer, VO_CHN VoChn, AX_U64 *u64ChnPts);
...
/* Others */
AX_S32 AX_VO_MemCpy_Open(AX_VOID);
AX_S32 AX_VO_MemCpy_Close(AX_VOID);
AX_S32 AX_VO_MemCpy_1D(AX_U64 u64SrcPhyAddr, AX_U64 u64DstPhyAddr, AX_U32 u32Size);
AX_S32 AX_VO_MemCpy_2D(AX_VO_MEMCPY_T *pstSrc, AX_VO_MEMCPY_T *pstDst);
