...
typedef enum _AX_VIN_PIPE_WORK_MODE_E_ {
    AX_VIN_PIPE_NORMAL_MODE0                 = 0,    /* Normal mode0: Full isp pipeline */
    AX_VIN_PIPE_NORMAL_MODE1                 = 1,    /* Normal mode1: Full isp pipeline */
    AX_VIN_PIPE_NORMAL_MODE2                 = 2,    /* Normal mode2: Full isp pipeline */
...
typedef enum _AX_VIN_FRAME_SOURCE_ID_E_ {
    ...
    AX_VIN_FRAME_SOURCE_ID_AINR = 2,
    AX_VIN_FRAME_SOURCE_ID_ITP  = 3,
    AX_VIN_FRAME_SOURCE_ID_YUV  = 4,
...
typedef struct __AX_VIN_FLASH_CMD_ATTR_T_ {
    AX_U32                          nCmdLightIdx;   /* flash light index */
    AX_U32                          nCmdUpdate;     /* Whether the cmd is updated */
    AX_U32                          nCmdType;       /* cmd type:
                                                        0: VIN_SYNC_LIGHT_CMD_MODE_REPLACE_FLASH
                                                        1: VIN_SYNC_LIGHT_CMD_MODE_INSERT */
    AX_U32                          nCmdBitWidth;   /* cmd bit width */
    AX_U32                          nCmdTimeWidth;  /* cmd time width */
    AX_U32                          nCmdData;       /* user private data */
}AX_VIN_FLASH_CMD_ATTR_T;
...
typedef struct _AX_VIN_FLASH_LIGHT_TIMING_ATTR_T_ {
    ...
    AX_VIN_FLASH_CMD_ATTR_T     tFlashExtendAttr;  /* It is a user-customized function.*/
...
typedef struct _AX_VIN_DEV_ATTR_T_ {
    ...
    AX_U32                                  nWidthStride[AX_HDR_CHN_NUM]; /* If the image is in YUV format, unit is bytes, and other format units are pixels */
...
typedef struct _AX_VIN_WARP_ATTR_T_ {
    AX_WARP_ENGINE_E            eWarpEngine;
    AX_WARP_MODE_U              uWarpMode;
} AX_VIN_WARP_ATTR_T;

typedef struct _AX_VIN_LOW_DELAY_ATTR_T_ {
    AX_BOOL                 bEnable;
    AX_U8                   nSliceNum;
} AX_VIN_LOW_DELAY_ATTR_T;
...
typedef enum _AX_VIN_PIPE_DUMP_NODE_E_ {
    ...
    AX_VIN_PIPE_DUMP_NODE_RLTM,         /* write data from rltm to ddr */
...
typedef struct _AX_VIN_STITICH_PIPE_ATTR_T_ {
    AX_U8                   nPipeId;
    AX_U8                   bMirrorFlip;
    AX_ISP_OVERLAP_INFO_T   tOverlapInfo[AX_VIN_OVERLAP_NUM];
} AX_VIN_STITICH_PIPE_ATTR_T;

typedef struct _AX_VIN_STITCH_GRP_ATTR_T_ {
    AX_U8                       bStitchEn;
    AX_U8                       bAroundView;
    AX_U8                       nMainPipeId;
    AX_U8                       nStitchPipeNum;
    AX_VIN_STITICH_PIPE_ATTR_T  tStitchPipeAttr[AX_VIN_STITCH_MAX_PIPE_NUM];
...
AX_S32 AX_VIN_SetStitchGrpAttr(AX_U8 nStitchGrp, const AX_VIN_STITCH_GRP_ATTR_T *pstStitchAttr);
AX_S32 AX_VIN_GetStitchGrpAttr(AX_U8 nStitchGrp, AX_VIN_STITCH_GRP_ATTR_T *pstStitchAttr);
...
AX_S32 AX_VIN_SetPipeLowDelayAttr(AX_U8 nPipeId, AX_VIN_LOW_DELAY_ATTR_T *ptLowDelayAttr);
AX_S32 AX_VIN_GetPipeLowDelayAttr(AX_U8 nPipeId, AX_VIN_LOW_DELAY_ATTR_T *ptLowDelayAttr);
...
AX_S32 AX_VIN_GetChnIRQTimeOut(AX_U8 nPipeId, AX_VIN_CHN_ID_E eChnId, AX_U8 nIrqIndex, AX_S32 nTimeOutMs);
