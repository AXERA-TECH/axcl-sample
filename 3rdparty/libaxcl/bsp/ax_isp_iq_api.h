...
typedef enum {
    ...
    AX_ISP_IQ_FPN_MODE1,         /* sbl + dark shading */
...
typedef struct {
    ...
    AX_U8           nOffset;
    AX_CHAR         *pszFpnFrame;
    AX_U32          nFpnFrameSize;
}AX_ISP_IQ_FPN_CALIBRATE_CFG_T;

typedef struct {
    AX_U32          nThreshold;
    AX_U32          nFrameNum;
    AX_ISP_IQ_FPN_CALIBRATE_CFG_T tFpnCaliCfg;
} AX_ISP_IQ_FPN_CALIBRATE_ATTR_T;
 ...
 ************************************************************************************/
#define AX_ISP_DS_AUTO_GAIN_GRP_NUM         (4)
#define AX_ISP_DS_AUTO_EXPOSE_TIME_GRP_NUM  (4)
#define AX_ISP_DS_MESH_SIZE_H               (73)
#define AX_ISP_DS_MESH_SIZE_V               (73)

typedef struct {
    AX_U16 nMeshLut[AX_ISP_DS_MESH_SIZE_H][AX_ISP_DS_MESH_SIZE_V];    /* mesh lut for the specific Again and ExposeTime. Accuracy: U8.8 Range: [0, 0xFFFF] */
} AX_ISP_IQ_DS_MESH_LUT_T;

typedef struct {
    AX_U8  nGainGrpNum;                               /* Gain dimension num. Accuracy: U8.0 Range: [0, AX_ISP_DS_AUTO_GAIN_GRP_NUM] */
    AX_U8  nExposeTimeGrpNum;                         /* ExposeTime dimension num. Accuracy: U8.0 Range: [0, AX_ISP_DS_AUTO_EXPOSE_TIME_GRP_NUM] */
    AX_U32 nGain[AX_ISP_DS_AUTO_GAIN_GRP_NUM];                /* Again value for sbl tunning. Accuracy: U22.10 Range: [0x400, 0xFFFFFFFF] */
    AX_U32 nExposeTime[AX_ISP_DS_AUTO_EXPOSE_TIME_GRP_NUM];   /* ExposeTime value for sbl tunning. Accuracy: U32 Range: [0x0, 0xFFFFFFFF] */
    AX_ISP_IQ_DS_MESH_LUT_T tMeshTab[AX_ISP_DS_AUTO_GAIN_GRP_NUM][AX_ISP_DS_AUTO_EXPOSE_TIME_GRP_NUM];    /* Dark Shading mesh table */
...
typedef struct {
    AX_U8  nAutoMode;         /* 0: manual, 1: auto */
    AX_U16 nMeshOffset;       /* Accuracy: U8.8 Range: [0, 0xFFFF] */
    AX_U8  nMeshRows;         /* status of valid mesh rows number; Accuracy: U8 Range: [0, 73] */
    AX_U8  nMeshCols;         /* status of valid mesh columns number; Accuracy:U8 Range: [0, 73] */
...
#define AINR_MODEL_MAX_NUM                (12)
#define AINR_DUMMY_MODEL_MAX_NUM          (2)
...
#define AINR_SENS_AUTO_TABLE_SIZE (4)
#define AINR_FREQ_AFFINE_AUTO_TABLE_SIZE (4)
#define AINR_FREQ_LUT_TABLE_SIZE (4)
...
typedef struct {
    AX_U8 nLowFreqNRAffine;                           /* Accuracy: U1.7 Range: [0, 128] */
    AX_U8 nMidFreqNRAffine;                        /* Accuracy:U1.7 Range: [0, 128] */
    AX_U8 nHighFreqNRAffine;                          /* Accuracy:U1.7 Range:	[0, 128] */
...
typedef struct {
    ...
    AX_U32 nRefValStart[AINR_NON_SENS_AUTO_TABLE_SIZE];     /* Gain start: Accuracy: U22.10 Range: [1024, 0xFFFFFFFF]; Lux: Accuracy: U22.10 Range: [0, 0xFFFFFFFF] */
    AX_U32 nRefValEnd[AINR_NON_SENS_AUTO_TABLE_SIZE];     /* Gain end: Accuracy: U22.10 Range: [1024, 0xFFFFFFFF]; Lux: Accuracy: U22.10 Range: [0, 0xFFFFFFFF] */
...
typedef struct {
    ...
    AX_U32 nRefVal[AINR_FREQ_AFFINE_AUTO_TABLE_SIZE];     /* Gain: Accuracy: U22.10 Range: [1024, 0xFFFFFFFF]; Lux: Accuracy: U22.10 Range: [0, 0xFFFFFFFF] */
    AX_U8 nLowFreqNRAffine[AINR_FREQ_AFFINE_AUTO_TABLE_SIZE];                           /* Accuracy: U1.7 Range: [0, 128] */
    AX_U8 nMidFreqNRAffine[AINR_FREQ_AFFINE_AUTO_TABLE_SIZE];                        /* Accuracy:U1.7 Range: [0, 128] */
    AX_U8 nHighFreqNRAffine[AINR_FREQ_AFFINE_AUTO_TABLE_SIZE];                          /* Accuracy:U1.7 Range: [0, 128] */
} AX_ISP_IQ_FREQ_AFFINE_AUTO_PARAM_T;

typedef struct {
    AX_U8  nParamGrpNum;                       /* Accuracy: U8.0 Range: [0x0, 0x8] */
    AX_U32 nRefValStart[AINR_FREQ_LUT_TABLE_SIZE];     /* Gain start: Accuracy: U22.10 Range: [1024, 0xFFFFFFFF]; Lux: Accuracy: U22.10 Range: [0, 0xFFFFFFFF] */
    AX_U32 nRefValEnd[AINR_FREQ_LUT_TABLE_SIZE];     /* Gain end: Accuracy: U22.10 Range: [1024, 0xFFFFFFFF]; Lux: Accuracy: U22.10 Range: [0, 0xFFFFFFFF] */
...
typedef struct {
    ...
    AX_U8 nRefMode;  /* Accuracy: U1.0 Range: [0x0, 0x1], 0:use lux as ref, 1:use gain as ref, but only support gain mode now, sdk return err_no_support when set lux**/
...
typedef struct {
    AX_U8 nMode;                  /*0: Relative level mode.Use the current parameter as the maximum level value. 1: Absolute level mode. Use the maximum parameter in the principle as the maximum level. Accuracy: U1 Range: [0, 1],default:0.*/
...
#define AICE_MODEL_MAX_NUM                (12)
#define AICE_DUMMY_MODEL_MAX_NUM          (2)
#define AICE_BIAS_SIZE (4)
#define AICE_STRENGTH_LUT_COLUMN (2)
#define AICE_LUMA_STRENGTH_LUT_ROW (16)
#define AICE_LUMA_LUT_AUTO_TABLE_SIZE (4)
#define AICE_FREQ_AFFINE_AUTO_TABLE_SIZE (4)
...
typedef struct {
    AX_U8  nParamGrpNum;                       /* Accuracy: U8.0 Range: [0x0, 0x8] */
    AX_U32 nRefValStart[AICE_LUMA_LUT_AUTO_TABLE_SIZE];     /* Gain start: Accuracy: U22.10 Range: [1024, 0xFFFFFFFF]; Lux: Accuracy: U22.10 Range: [0, 0xFFFFFFFF] */
    AX_U32 nRefValEnd[AICE_LUMA_LUT_AUTO_TABLE_SIZE];     /* Gain end: Accuracy: U22.10 Range: [1024, 0xFFFFFFFF]; Lux: Accuracy: U22.10 Range: [0, 0xFFFFFFFF] */
...
typedef struct {
    AX_U8  nParamGrpNum;                       /* Accuracy: U8.0 Range: [0x0, 0x8] */
    AX_U32 nRefVal[AICE_FREQ_AFFINE_AUTO_TABLE_SIZE];     /* Gain: Accuracy: U22.10 Range: [1024, 0xFFFFFFFF]; Lux: Accuracy: U22.10 Range: [0, 0xFFFFFFFF] */
...
typedef struct {
 ...
 typedef struct {
    AX_U8                           nValidNum;
    AX_ISP_IQ_AICE_CAPABILITY_T     tModelCapList[AICE_MODEL_MAX_NUM];
} AX_ISP_IQ_AICE_CAP_TABLE_T;

typedef struct {
    AX_U8 nMode;                  /*0: Relative level mode.Use the current parameter as the maximum level value. 1: Absolute level mode. Use the maximum parameter in the principle as the maximum level. Accuracy: U1 Range: [0, 1],default:0.*/
    AX_S8 nSpatialCeLevel;        /*for spatial CE level. default:0. Accuracy: S8 Range: [-127, 127] */
    AX_S8 nTemporalNrLevel;       /*for temporal NR level. default:0. Accuracy: S8 Range: [-127, 127] */
} AX_ISP_IQ_AICE_LEVEL_T;
...
} AX_ISP_IQ_RAW3DNR_MTD_HDRRATIO_PARAM_T;
...
} AX_ISP_IQ_RAW3DNR_MTD_HDRRATIO_AUTO_PARAM_T;
...
typedef struct  {
    ...
    AX_ISP_IQ_RAW3DNR_MTD_HDRRATIO_PARAM_T tHrParam;
...
typedef struct {
    ...
    AX_ISP_IQ_RAW3DNR_MTD_HDRRATIO_AUTO_PARAM_T tHrParam[AX_ISP_HDR_RATIO_GRP_NUM];
} AX_ISP_IQ_RAW3DNR_MTD_HR_AUTO_T;
...
typedef struct  {
    ...
    AX_ISP_IQ_RAW3DNR_MTD_HR_AUTO_T tHrAuto;
...
} AX_ISP_IQ_RAW3DNR_SD_HDRRATIO_PARAM_T;
...
} AX_ISP_IQ_RAW3DNR_SD_HDRRATIO_AUTO_PARAM_T;
...
typedef struct  {
    ...
    AX_ISP_IQ_RAW3DNR_SD_HDRRATIO_PARAM_T tHrParam;
} AX_ISP_IQ_RAW3DNR_SD_MANUAL_T;

typedef struct {
    AX_U8  nHrGrpNum;                                           /* Accuracy: U8.0 Range: [1, AX_ISP_HDR_RATIO_GRP_NUM] */
    AX_U32 nHrRefVal[AX_ISP_HDR_RATIO_GRP_NUM];                 /* Hdr Ratio: Accuracy: U7.0 Range: [0x400, 0x1FC00] */
    AX_ISP_IQ_RAW3DNR_SD_HDRRATIO_AUTO_PARAM_T tHrParam[AX_ISP_HDR_RATIO_GRP_NUM];
} AX_ISP_IQ_RAW3DNR_SD_HR_AUTO_T;
...
typedef struct  {
    ...
    AX_ISP_IQ_RAW3DNR_SD_HR_AUTO_T  tHrAuto;
 ...
 ************************************************************************************/
typedef struct {
    AX_U8  nWbcEn;      /* WBC Hardware Enable */
...
typedef struct {
    ...
    AX_U8  nDetStrength[AX_ISP_AUTO_TABLE_MAX_NUM];      /* Accuracy: U3.5 Range: [0x0, 0x60] */
    AX_S16 nDetColorCenter[AX_ISP_AUTO_TABLE_MAX_NUM][AX_ISP_DEPURPLE_DET_COLOR_NUM][AX_ISP_DEPURPLE_DET_COLOR_CH];        /* Accuracy: S8.4 Range: [-4096, 4095] */
    AX_U16 nDetColorRadius[AX_ISP_AUTO_TABLE_MAX_NUM][AX_ISP_DEPURPLE_DET_COLOR_NUM][AX_ISP_DEPURPLE_DET_COLOR_CH];        /* Accuracy: U8.4 Range: [0x0, 0xFFF] */
    AX_U8  nDetGetcompcolorGrad[AX_ISP_AUTO_TABLE_MAX_NUM][AX_ISP_DEPURPLE_DET_COLOR_NUM][AX_ISP_DEPURPLE_DET_COLOR_CH];   /* Accuracy: U4 Range: [0x0, 0xF] */
...
typedef struct {
    ...
    AX_U8  nFcCorUvLevel;               /* False color correction uv level.     Accuracy:U1.4  Range:[0x0,0x10] */
    AX_U16 nFcCorLevel;                 /* False color correction weight range. Accuracy:U1.8  Range:[0x0,0x100] */
} AX_ISP_IQ_DEMOSAIC_MANUAL_T;

typedef struct {
    AX_U8  nParamGrpNum;                                         /* Accuracy:U8.0  Range:[0x1, AX_ISP_AUTO_TABLE_MAX_NUM] Default: AX_ISP_AUTO_TABLE_MAX_NUM */
    AX_U32 nRefVal[AX_ISP_AUTO_TABLE_MAX_NUM];                /* Accuracy:U22.10  GainRange:[0x400, 0xFFFFFFFF] LuxRange:[0x0, 0xFFFFFFFF] */
    AX_U8  nEdgeDirectEstStrength[AX_ISP_AUTO_TABLE_MAX_NUM]; /* Accuracy:U2.6  Range:[0x0,0xFF] */
    AX_U8  nFcCorUvLevel[AX_ISP_AUTO_TABLE_MAX_NUM];          /* Accuracy:U1.4  Range:[0x0,0x10] */
    AX_U16 nFcCorLevel[AX_ISP_AUTO_TABLE_MAX_NUM];            /* Accuracy:U1.8  Range:[0x0,0x100] */
} AX_ISP_IQ_DEMOSAIC_AUTO_T;

typedef struct {
    AX_U8  nDemosaicEn;                 /* Demosaic module enable.  Range:[0,1], 0: Disable, 1: Enable */
    AX_U8  nFcCorEnable;                /* False color correction enable.  Range:[0,1], default:1 */
    AX_U8  nAutoMode;                   /* for ref auto or manual adjust mode. Range:[0,1], 0: manual, 1:auto, default:1 */
    AX_U8  nRefMode;                    /* choose ref mode. Range:[0,1], 0:use lux as ref, 1:use gain as ref */
    AX_U8  nMode;                       /* choose work mode. Range:[0,2], 0: normal, 1: gray, 2: green */
...
typedef struct {
    AX_U8  nGicStrengthLut[AX_ISP_GIC_STRENGTH_LUT_SIZE];  /* Green imbalance correction strength lut. Accuracy:U1.7  Range:[0x0,0x80], Default: all 0x80 */
} AX_ISP_IQ_GIC_MANUAL_T;

typedef struct {
    AX_U8  nParamGrpNum;                                                              /* Accuracy:U8.0  Range:[0x1, AX_ISP_AUTO_TABLE_MAX_NUM] Default: AX_ISP_AUTO_TABLE_MAX_NUM */
    AX_U32 nRefVal[AX_ISP_AUTO_TABLE_MAX_NUM];                                          /* Accuracy:U22.10  GainRange:[0x400, 0xFFFFFFFF] LuxRange:[0x0, 0xFFFFFFFF] */
    AX_U8  nGicStrengthLut[AX_ISP_AUTO_TABLE_MAX_NUM][AX_ISP_GIC_STRENGTH_LUT_SIZE];    /* Accuracy:U1.7  Range:[0x0, 0x80] Default: all 0x80 */
...
typedef struct {
    AX_ISP_LUT_MODE_E               eLutMode;                                       /* Interpolation method of LUT table, 0: linear, 1: exponential, default:1. Accuracy: U1.0 Range: [0, 1] */
...
#define AX_ISP_DEHAZE_STATS_MAX_H            (256)
#define AX_ISP_DEHAZE_STATS_MAX_W            (512)
...
typedef struct {
    ...
    AX_U16 nDcStats[AX_ISP_DEHAZE_STATS_MAX_NUM]; /* Accuracy: U8.4, Dark Channel Statitics */
...
typedef struct {
    AX_S16  nYnrCenter[AX_ISP_YNR_CMASK_CENTER_SIZE];   /* ynr cmask center [0]:Y, [1]:U, [2]:V. Accuracy: S8.4 Range: Y:[0, 4095], UV:[-2048, 2047] */
...
typedef struct {
    AX_U8   nParamGrpNum;                                                           /* Accuracy: U8.0 Range: [0, AX_ISP_AUTO_TABLE_MAX_NUM] */
    AX_U32  nRefVal[AX_ISP_AUTO_TABLE_MAX_NUM];                                     /* Gain: Accuracy: U22.10 Range: [0x400, 0xFFFFFFFF]; Lux: Accuracy: U22.10 Range: [0, 0xFFFFFFFF] */
    AX_S16  nYnrCenter[AX_ISP_AUTO_TABLE_MAX_NUM][AX_ISP_YNR_CMASK_CENTER_SIZE];    /* ynr cmask center [0]:Y, [1]:U, [2]:V. Accuracy: S8.4 Range: Y:[0, 4095], UV:[-2048, 2047] */
    ...
    AX_U8   nYnrSmooth[AX_ISP_AUTO_TABLE_MAX_NUM][AX_ISP_YNR_CMASK_SMOOTH_SIZE];    /* ynr cmask smooth [0]:Y, [1]:U, [2]:V. Accuracy: U3 Range: [0, 7] */
...
typedef struct {
    ...
    AX_U8       nSignalRangeMode;                   /* full range: 0, limited range: 1, default: 0, Accuracy: U2 Range: [0, 2] */
 ...
 *  DIS IQ Param
 ************************************************************************************/
#define AX_ISP_DIS_FRAME_POS_WEIGHTS_MAX_NUM     (16)
#define AX_ISP_DIS_V2_MATRIX_H_SIZE              (3)
#define AX_ISP_DIS_V2_MATRIX_V_SIZE              (3)

typedef enum
{
    AX_ISP_IQ_DIS_TYPE_V1,
    AX_ISP_IQ_DIS_TYPE_V2,
} AX_ISP_IQ_DIS_TYPE_E;

typedef struct {
    AX_U8  nDelayFrameNum;                                          /* delay num, the more, the smoother. defalut 0. Accuracy: U3 Range: [0, 6] */
    AX_U8  nHistoryFrameNum;                                        /* history frame, the more, the smoother. defalut 2. Accuracy: U8 Range: [1, 16] */
    AX_U8  nCropRatio;                                              /* crop ratio for warped image, defalut 204. Accuracy: U8 Range: [127, 255] */
    AX_U8  nAlgoType;                                               /* different algo implement, defalut 1. Accuracy: U3 Range: [0, 2] */
    AX_U8  nFramePosWeights[AX_ISP_DIS_FRAME_POS_WEIGHTS_MAX_NUM];  /* history frame position weighted, defalut 1. Accuracy: U8 Range: [0, 255] */
    AX_U16 nLargeMovementThreshold;                                 /* large movement threshold, defalut 350. Accuracy: U16 Range: [0, 65535] */
    AX_U8  nDecayRate;                                              /* The decay rate of motion compensation, defalut 192. Accuracy: U8 Range: [0, 255] */
    AX_U8  nFeatPtsMinNum;                                          /* feat point minnum, defalut 8. Accuracy: U8 Range: [0, 255] */
    AX_U16 nKFPredictedError;                                       /* kalman filter predicted error, defalut 256. Accuracy: U12 Range: [0, 4095] */
    AX_U16 nKFProcessNoise;                                         /* kalman filter process noise, defalut 12. Accuracy: U12 Range: [0, 4095] */
    AX_U16 nKFObservationNoise;                                     /* kalman filter observation noise, defalut 128. Accuracy: U12 Range: [0, 4095] */
    AX_U8  nDebugMode;                                              /* debug mode, defalut 0. Accuracy: U2 Range: [0, 3] */
} AX_ISP_IQ_DIS_V1_PARAM_T;

typedef struct {
    AX_U8  nCropRatio;                                                            /* crop factor. defalut 204. Accuracy: U8.0 Range: [16, 255] */
    AX_S32 nTimeLag;                                                              /* IMU timestamp offset. defalut 0. Accuracy: S32.0 Range: [-2147483647, 2147483647] */
    AX_S32 nIntrinsics[AX_ISP_DIS_V2_MATRIX_H_SIZE][AX_ISP_DIS_V2_MATRIX_V_SIZE]; /* Camera intrinsics parameters. Accuracy: AX_S32.0 Range: [-2147483647, 2147483647] */
    AX_S32 nExtrinsics[AX_ISP_DIS_V2_MATRIX_H_SIZE][AX_ISP_DIS_V2_MATRIX_V_SIZE]; /* Camera extrinsics parameters. Accuracy: AX_S32.0 Range: [-2147483647, 2147483647] */
    AX_U32 nStaticTheta;                                                          /* IMU statistical threshold, defalut 20. Accuracy: U32.0 Range: [0, 65536] */
    AX_U32 nZeroBiasTheta;                                                        /* IMU Rotation angle threshold, defalut 1. Accuracy: U32.0 Range: [0, 65536] */
    AX_U32 nErrorToWarning;                                                       /* Aspect ratio cropping status, defalut 983. Accuracy: U32.0 Range: [0, 65536] */
    AX_U32 nAnyToSafe;                                                            /* Aspect ratio cropping status, defalut 655. Accuracy: U32.0 Range: [0, 65536] */
    AX_U32 nSafeToWarning;                                                        /* Aspect ratio cropping status, defalut 655. Accuracy: U32.0 Range: [0, 65536] */
    AX_U32 nWarningScale;                                                         /* warning scale, defalut 282. Accuracy: U32.0 Range: [0, 65536] */
} AX_ISP_IQ_DIS_V2_PARAM_T;

typedef struct {
    AX_U8                       bDisEnable;          /* EIS enable, 0: disable, 1:enable, default:0. Accuracy: U1 Range: [0, 1] */
    AX_U8                       nDisType;            /* DIS type, Accuracy: U8.0 Range: [0, AX_ISP_IQ_DIS_TYPE_V2]. This value is not supported for dynamic change at runtime */
    AX_ISP_IQ_DIS_V1_PARAM_T    tDisV1Param;         /* Based on ME Statistics */
    AX_ISP_IQ_DIS_V2_PARAM_T    tDisV2Param;         /* Based on Gyro Data */
} AX_ISP_IQ_DIS_PARAM_T;

typedef struct {
    AX_U8  nGetDelayFrameNum;                                          /* delay num, the more, the smoother. defalut 0. Accuracy: U3 Range: [0, 6] */
    AX_U8  nGetHistoryFrameNum;                                        /* history frame, the more, the smoother. defalut 2. Accuracy: U8 Range: [1, 16] */
} AX_ISP_IQ_DIS_GET_WEIGHTS_PARAM_T;
...
typedef struct {
    ...
    AX_U8                        nLayerNum;          /* pyramid layers, not supported dynamic modification. defalut 6. Accuracy: U8 Range: [3, 6] */
...
typedef struct {
    ...
    AX_U16 nRoiRegionW;       /* regionW, must be even, Accuracy: U10.0, Range: Roi0[0, 512], Roi1[0, image_width_max -1], nRoiOffsetH + (nRoiRegionNumH * nRoiRegionW) <= hsize */
    AX_U16 nRoiRegionH;       /* regionH, must be even, Accuracy: U10.0, Range: Roi0[0, 512], Roi1[0, image_high_max -1], nRoiOffsetV + (nRoiRegionNumV *nRoiRegionH) <= vsize */
...
typedef struct {
    ...
    AX_U16 nRoiWidth;         /* RoiWidth, Accuracy: U13.0, Range: [0, image_width_max -1], nRoiOffsetH + nRoiWidth <= hsize */
    AX_U16 nRoiHeight;        /* RoiHeight, Accuracy: U10.0, Range: [0, image_high_max -1], nRoiOffsetV + nRoiHeight <= vsize  */
...
typedef struct {
    ...
    AX_U32 nFrameType;                                      /* AX_ISP_FRAME_TYPE_E */
...
typedef struct {
    AX_U32 nLSWinSum[AX_AWB_WIN_LUMA_CHN][AX_AWB_WIN_CHN];
    AX_U16 nLSWinNum[AX_AWB_WIN_LUMA_CHN];
    AX_U32 nNGWinSum[AX_AWB_WIN_LUMA_CHN][AX_AWB_WIN_CHN];
    AX_U16 nNGWinNum[AX_AWB_WIN_LUMA_CHN];
} AX_AWB_WIN_STATS_T;
...
typedef struct {
    AX_U32 nPixCount;               /* Accuracy:U18 Range:[0, 2^18-1] */
    AX_U32 nPixSum;                 /* Accuracy:U26.6 Range:[0, 2^32-1] */
    AX_U64 nFocusValue;             /* Accuracy:U31.10 Range:[0, 2^41-1] */
    AX_U64 nFocusValueLumaSuppress; /* Accuracy:U31.10 Range:[0, 2^41-1] */
    AX_U32 nBrightPixCount;         /* Accuracy:U18 Range:[0, 2^18-1] */
...
typedef struct {
    AX_U8 nType;        /* Accuracy: U1.0 Range: [0, 1], 0: nFocusValue, 1: nFocusValueLumaSuppress*/
    AX_F32 fCoeff;      /* Accuracy:F32 Range: >= 1.0 */
    AX_U64 nMaxValueV;  /* Accuracy:U31.10 Range:[0, 2^41-1] */
    AX_U64 nMaxValueH1; /* Accuracy:U31.10 Range:[0, 2^41-1] */
    AX_U64 nMaxValueH2; /* Accuracy:U31.10 Range:[0, 2^41-1] */
    AX_ISP_AF_STAT_INFO_T* pStat;
} AX_ISP_AF_STAT_INFO_IN_T;

typedef struct {
    AX_U16  nFocusValueV; /* Accuracy:U16 Range:[0, 65535] */
    AX_U16  nFocusValueH1;/* Accuracy:U16 Range:[0, 65535] */
    AX_U16  nFocusValueH2;/* Accuracy:U16 Range:[0, 65535] */
...
AX_S32 AX_ISP_IQ_SetFpnCalibrate(AX_U8 nPipeId, AX_ISP_IQ_FPN_CALIBRATE_ATTR_T *pstCalibrateAttr);
...
AX_S32 AX_ISP_IQ_SetAiceLevel(AX_U8 nPipeId, AX_ISP_IQ_AICE_LEVEL_T *pIspAiceLevel);
AX_S32 AX_ISP_IQ_GetAiceLevel(AX_U8 nPipeId, AX_ISP_IQ_AICE_LEVEL_T *pIspAiceLevel);
...
AX_S32 AX_ISP_IQ_GetFrameWeights(AX_U8 nPipeId, AX_ISP_IQ_DIS_GET_WEIGHTS_PARAM_T *pIspGetweightsParam,
                                    AX_U8 nFramePosWeights[AX_ISP_DIS_FRAME_POS_WEIGHTS_MAX_NUM]);
