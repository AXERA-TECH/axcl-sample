...
#define AX_AVS_MAX_OUT_WIDTH                    16384
#define AX_AVS_MAX_OUT_HEIGHT                   8192
#define AX_AVS_MIN_OUT_WIDTH                    256
...
typedef enum axAVS_ENGINE_MODE_E
{
    AVS_ENGINE_GDC = 0,
    AVS_ENGINE_MULTI_VDSP,
    AVS_ENGINE_SINGLE_VDSP0, /* Not support now. */
    AVS_ENGINE_MIX, /* Not support now. */
    AVS_ENGINE_BUTT
} AX_AVS_ENGINE_MODE_E;
...
typedef struct axAVS_GRP_ATTR_T
{
    ...
    AX_AVS_ENGINE_MODE_E        eEngineMode; /* RW; Choose Process Engine Mode */
