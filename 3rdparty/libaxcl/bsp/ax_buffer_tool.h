        ...
        AX_FRAME_COMPRESS_INFO_T *pstCompressInfo, AX_U32 uAlignSize)
{
    ...
    if (((uWidthStride * uPixBits) % 128) != 0) {
        uWidthBeat = ((uWidthStride * uPixBits) / 128) + 1;
    } else {
        uWidthBeat = (uWidthStride * uPixBits) / 128 ;
    }

    if (uAlignSize != 0) {
        uWidthBeat = ((uWidthBeat * 16 + uAlignSize - 1) / uAlignSize) * uAlignSize;
        uWidthBeat = uWidthBeat / 16;
    } else {
        uWidthBeat = ((uWidthBeat * 16 + 127) / 128) * 128;
        uWidthBeat = uWidthBeat / 16;
    }
        ...
        AX_U32 uAlignSizeByte)
{
    ...
    if (((uWidthPixel * uPixBits) % 128) != 0) {
        uWidthBeat = ((uWidthPixel * uPixBits) / 128) + 1;
    } else {
        uWidthBeat = (uWidthPixel * uPixBits) / 128 ;
    }

    if (uAlignSizeByte != 0) {
        uStrideByte = ((uWidthBeat * 16 + uAlignSizeByte - 1) / uAlignSizeByte) * uAlignSizeByte;
    } else {
        uStrideByte = ((uWidthBeat * 16 + 127) / 128 * 128) ;
    }
